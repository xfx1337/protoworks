...
from PySide6.QtWidgets import QFileSystemModel, QTreeView, QWidget, QVBoxLayout, QHBoxLayout, QFileDialog, QLabel, QPushButton, QCheckBox


# copy pasted..

class QDirTree(QWidget):
    def __init__(self, root_path, enable_choosing_root=False):
        super().__init__()
