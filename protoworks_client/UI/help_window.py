...
class HelpWindow(QWidget):
    def __init__(self):
        ...
        self.logo = QLabel()
        pixmap = env.templates_manager.backgrounds["protoworks_logo_mini"]
        self.logo.setPixmap(pixmap)

        self.layout.addWidget(self.logo)

        self.main_label = QLabel("ProtoWorks - комплекс программного обеспечения для автоматизации технических процессов производства в сфере 3Д печати.")
