...
SLAVE_TYPES_STR = ["FDM_OCTO", "FDM_KLIPPER", "FDM_DIRECT", "SLA", "MILL"]
FDM_OCTO = 0
FDM_KLIPPER = 1
FDM_DIRECT = 2
SLA = 3
...
GCODE_TYPES_STR = ["Marlin"]
GCODE_MARLIN = 0
GCODE_TYPES_TRANSLATIONS = {
    GCODE_MARLIN: "Marlin"
}

GCODE_TYPES_TRANSLATIONS_BACKWARDS = {
    "Marlin": GCODE_MARLIN
}

SLAVES_TYPES_TRANSLATIONS = {
    FDM_OCTO: "FDM_OCTO",
    FDM_KLIPPER: "FDM_KLIPPER",
    FDM_DIRECT: "FDM_DIRECT",
    SLA: "SLA",
    MILL: "MILL"
}

SLAVES_TYPES_TRANSLATIONS_BACKWARDS = {
    "FDM_OCTO": 0,
    "FDM_KLIPPER": 1,
    "FDM_DIRECT": 2,
    "SLA": 3,
...
ORCA_SLICER_INPUT_FILES = ["stl"]

FAKE_OCTO_FIRST_PORT = 5100