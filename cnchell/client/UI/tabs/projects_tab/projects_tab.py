...
class ProjectsWidget(QWidget, Tab):
    ...
    def ask_for_files(self, project_id):
        ...
        self.dlg = QAskForDirectoryDialog("Если у вас есть файлы проекта, загрузите их", project_id=project_id,
    ...
    def _transfer_files_processing(self, path, project_id):
        ...
        func_check_update = lambda: env.net_manager.files.after_project_update(project_id)
